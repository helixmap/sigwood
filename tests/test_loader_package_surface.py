...
_SURFACE = [
    ...
    "AvailabilityState", "AvailabilityReason", "ExportAvailability",
    "CoverageLane", "CoverageDecisionReason", "CoverageDecision",
    ...
    "PROVENANCE_MANIFEST_NAME", "PROVENANCE_LOCK_NAME",
    "PROVENANCE_STAGE_PREFIX", "PROVENANCE_SCHEMA_VERSION",
    "MAX_PROVENANCE_BYTES", "MAX_AVAILABILITY_SPANS",
    "ProvenanceEntry", "ProvenanceManifest", "ProvenanceManifestError",
    "is_reserved_provenance_path", "reject_explicit_reserved_path",
    "parse_manifest_bytes", "read_manifest", "canonical_manifest_bytes",
    "hash_file", "validate_selected_files",
